...
> เคล็ดลับสำหรับนักพัฒนา: เปิดด้วย `?mock=1` ต่อท้าย URL (เช่น `http://localhost:5173/?mock=1`) เพื่อใช้กล้องจำลอง (แคนวาสเคลื่อนไหว) — ระบบ tracking และ UI ทั้งหมดจะทำงานเต็มรูปแบบบนเครื่องที่ไม่มีกล้องหรือไม่อยากให้สิทธิ์กล้อง เหมาะกับการทดสอบและเดโม่
